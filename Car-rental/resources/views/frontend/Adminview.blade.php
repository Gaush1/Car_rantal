                                ...
                                <div class="menu_side_area">
                                    <div class="de-login-menu">
                                        ...
                                        <span id="de-click-menu-profile" class="de-menu-profile">
                                            <img src="{{ url('frontend/images/profile/1.jpg') }}" class="img-fluid"
                                                alt="">
                                        </span>
                                        ...
                                        <div id="de-submenu-profile" class="de-submenu">
                                            <div class="d-name">
                                                ...
                                                <span class="text-gray">{{ Auth::guard('admin')->user()->email }}
                                                </span>
                                            </div>
                        ...
                        <div class="row-lg-3 mb30">
                            <div class="card p-4 rounded-5">
                                <div class="profile_avatar">
                                    ...
                                    <div class="profile_name">
                                        <h4>
                                            ...
                                            <span
                                                class="profile_username text-gray">{{ Auth::guard('admin')->user()->email }}
                                            </span>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <ul class="menu-col">
                                    ...
                                    <li><a href="{{ route('admin.logout') }}"><i class="fa fa-sign-out"></i>Sign
                                            Out</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card p-4 rounded-5 mb25">
                                ...
                                <table class="table de-table">
                                    <thead>
                                        <tr>
                                            <th scope="col"><span class="text-uppercase fs-12 text-gray">Customer
                                                    ID</span></th>
                                            <th scope="col"><span class="text-uppercase fs-12 text-gray">Customer
                                                    Name</span></th>
                                            <th scope="col"><span class="text-uppercase fs-12 text-gray">Customer
                                    ...
                                    <tbody>
                                        @foreach ($users as $item)
                                            <tr>
                                                <td><span class="d-lg-none d-sm-block">Customer ID</span>
                                                    <div class="badge bg-gray-100 text-dark">{{ $item->id }}</div>
                                                </td>
                                                <td><span class="d-lg-none d-sm-block">Customer Name</span><span
                                                        class="bold">{{ $item->name }}</span></td>
                                                <td><span class="d-lg-none d-sm-block">Customer Email</span><span
                                                        class="bold">{{ $item->email }}</span></td>
                                                <td><span class="d-lg-none d-sm-block">Customer Username</span
                                                        class="bold">{{ $item->username }}</td>
                                                <td><span class="d-lg-none d-sm-block">Customer Phone No.</span
                                                        class="bold">{{ $item->phone }}</td>
                                                @if ($item->status == 'active')
                                                    <td>
                                                        <div class="badge rounded-pill bg-success">{{ $item->status }}
                                                        </div>
                                                    </td>
                                                @else
                                                    <td>
                                                        <div class="badge rounded-pill bg-danger">{{ $item->status }}
                                                        </div>
                                                    </td>
                                                @endif
