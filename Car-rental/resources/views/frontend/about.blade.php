...
@section('main-container')
        ...
        <div class="no-bottom no-top zebra" id="content">
            ...
            <section aria-label="section" class="jarallax text-light">
                <img src="frontend/images/background/8.jpg" class="jarallax-img" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="frontend/images/team/2.jpg" class="fp-image img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="frontend/images/team/3.jpg" class="fp-image img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="frontend/images/team/4.jpg" class="fp-image img-fluid" alt="">
                                </div>
