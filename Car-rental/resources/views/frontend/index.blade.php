...
@section('main-container')
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="section-hero" aria-label="section" class="jarallax">
                <img src="frontend/images/background/1.jpg" class="jarallax-img" alt="">
                <div class="container">
                                        ...
                                        <div class="col-lg-6 mb30">
                                            ...
                                            <div class="de_form de_radio row g-3">
                                                <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                    ...
                                                    <label for="radio-1a"><img src="frontend/images/select-form/car.png" alt="">Car</label>
                                                </div>

                                                <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                    <input id="radio-1b" name="Car_Type" type="radio" value="Office">
                                                    <label for="radio-1b"><img src="frontend/images/select-form/van.png" alt="">Van</label>
                                                </div>

                                                <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                    <input id="radio-1c" name="Car_Type" type="radio" value="Commercial">
                                                    <label for="radio-1c"><img src="frontend/images/select-form/minibus.png" alt="">Minibus</label>
                                                </div>

                                                <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                    <input id="radio-1d" name="Car_Type" type="radio" value="Retail">
                                                    <label for="radio-1d"><img src="frontend/images/select-form/sportscar.png" alt="">Prestige</label>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section aria-label="section">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <img src="frontend/images/misc/car.png" alt="" class="img-fluid wow fadeInUp">
                        </div>
            ...
            <section class="text-light jarallax">
                <img src="frontend/images/background/2.jpg" class="jarallax-img" alt="">
                <div class="container">
                    <div class="row g-5">
                        ...
                        <div id="items-carousel" class="owl-carousel wow fadeIn">
                          @foreach ($cars as $item)
                                    ...
                                    <div class="d-info">
                                        <div class="d-text">
                                            ...
                                            <div class="d-atr-group">
                                                ...
                                                <span class="d-atr"><img src="frontend/images/icons/4.svg" alt="">Sedan</span>
                                            </div>
                                            <div class="d-price">
                            ...
                            <div class="col-lg-12">
                                <div class="de-item mb30">
                                    <div class="d-img">
                                        <img src="frontend/images/cars/ferrari-enzo.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="d-info">
                                        <div class="d-text">
                                            <h4>Ferarri Enzo</h4>
                                            ...
                                            <div class="d-atr-group">
                                                ...
                                                <span class="d-atr"><img src="frontend/images/icons/2.svg" alt="">2</span>
                                                <span class="d-atr"><img src="frontend/images/icons/3.svg" alt="">4</span>
                                                <span class="d-atr"><img src="frontend/images/icons/4.svg" alt="">Exotic Car</span>
                                            </div>
                                            <div class="d-price">
                            ...
                            <div class="col-lg-12">
                                <div class="de-item mb30">
                                    <div class="d-img">
                                        <img src="frontend/images/cars/ford-raptor.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="d-info">
                                        <div class="d-text">
                                            <h4>Ford Raptor</h4>
                                            ...
                                            <div class="d-atr-group">
                                                ...
                                                <span class="d-atr"><img src="frontend/images/icons/2.svg" alt="">2</span>
                                                <span class="d-atr"><img src="frontend/images/icons/3.svg" alt="">4</span>
                                                <span class="d-atr"><img src="frontend/images/icons/4.svg" alt="">Pickup Truck</span>
                                            </div>
                                            <div class="d-price">
                            ...
                            <div class="col-lg-12">
                                <div class="de-item mb30">
                                    <div class="d-img">
                                        <img src="frontend/images/cars/mini-cooper.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="d-info">
                                        <div class="d-text">
                                            <h4>Mini Cooper</h4>
                                            ...
                                            <div class="d-atr-group">
                                                ...
                                                <span class="d-atr"><img src="frontend/images/icons/2.svg" alt="">2</span>
                                                <span class="d-atr"><img src="frontend/images/icons/3.svg" alt="">4</span>
                                                <span class="d-atr"><img src="frontend/images/icons/4.svg" alt="">Hatchback</span>
                                            </div>
                                            <div class="d-price">
                            ...
                            <div class="col-lg-12">
                                <div class="de-item mb30">
                                    <div class="d-img">
                                        <img src="frontend/images/cars/vw-polo.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="d-info">
                                        <div class="d-text">
                                            <h4>VW Polo</h4>
            ...
            <section class="text-light jarallax" aria-label="section">
                <img src="frontend/images/background/3.jpg" alt="" class="jarallax-img">
                <div class="container">
                    <div class="row">
                    <div class="col-lg-3">
                            ...
                            <div class="bloglist s2 item">
                                <div class="post-content">
                                    <div class="post-image">
                                        ...
                                        <img alt="" src="frontend/images/news/pic-blog-1.jpg" class="lazy">
                                    </div>
                                    <div class="post-text">                         
                            ...
                            <div class="bloglist s2 item">
                                <div class="post-content">
                                    <div class="post-image">
                                        ...
                                        <img alt="" src="frontend/images/news/pic-blog-2.jpg" class="lazy">
                                    </div>
                                    <div class="post-text">                           
                            ...
                            <div class="bloglist s2 item">
                                <div class="post-content">
                                    <div class="post-image">
                                        ...
                                        <img alt="" src="frontend/images/news/pic-blog-3.jpg" class="lazy">
                                    </div>
                                    <div class="post-text">                            
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="frontend/images/testimonial/1.jpg" class="img-fluid" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="frontend/images/testimonial/2.jpg" class="img-fluid" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="frontend/images/testimonial/3.jpg" class="img-fluid" alt="">
                            </div>
                        </div>
