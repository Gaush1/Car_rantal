...
@section('maincompany-container')
        ...
        <div class="no-bottom no-top" id="content">
                                    ...
                                    <div class="d-info">
                                        <div class="d-text">
                                            ...
                                            <div class="d-atr-group">
                                                <span class="d-atr"><img src="{{url("frontend/images/icons/1.svg")}}" alt="">{{$item->capacity}}</span>
                                                <span class="d-atr"><img src="{{url("frontend/images/icons/2.svg")}}" alt="">{{$item->storage}}</span>
                                                <span class="d-atr"><img src="{{url("frontend/images/icons/3.svg")}}" alt="">{{$item->doors}}</span>
                                                <span class="d-atr"><img src="{{url("frontend/images/icons/4.svg")}}" alt="">{{$item->bodytype}}</span>
                                            </div>
                                            <div class="d-price">
            ...
            <section class="text-light jarallax" aria-label="section">
                <img src="{{url("frontend/images/background/3.jpg")}}" alt="" class="jarallax-img">
                <div class="container">
                    <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="{{url("frontend/images/testimonial/1.jpg")}}" class="img-fluid" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="{{url("frontend/images/testimonial/2.jpg")}}" class="img-fluid" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="de-image-text">
                                ...
                                <img src="{{url("frontend/images/testimonial/3.jpg")}}" class="img-fluid" alt="">
                            </div>
                        </div>
